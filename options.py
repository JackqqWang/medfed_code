...
def args_parser():
    ...
    # specical arguments
    parser.add_argument('--public', default=1, help="1 is public")
    parser.add_argument('--T', default=1, help="1 TEMP")
    parser.add_argument('--test_pass', default=1, help="1 is we just use small model to test")
    parser.add_argument('--pub_batch_size', type=int, default=4,
                        help="public batch size")
    parser.add_argument('--dataset', type=str, default='ChestXray_binary', help="name \
